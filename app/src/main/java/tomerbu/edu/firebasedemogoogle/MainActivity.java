    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mFirebaseUser == null) {
            ...
            if (mFirebaseUser.getPhotoUrl() != null) {
                ...
                Picasso.with(this).load(mPhotoUrl).into((ImageView) findViewById(R.id.ivUser));
            }
        }
// Write a message to the database
        ...
        readFromDB();
        addUser(mFirebaseUser.getUid(), mUsername, mFirebaseUser.getEmail());
        writeNewPost(mFirebaseUser.getUid(), mUsername, "Hello, Again", "This is the body Again");
    }
